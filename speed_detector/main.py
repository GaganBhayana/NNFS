...
if __name__ == '__main__':
	...
	while True:
		...
		cv2.line(frame,(0, Y_THRESH),(frame.shape[0], Y_THRESH),(255,0,0),2)
				...
				if len(vehicle.trace) > 1:
					...
					try:
						...
						if trace_y <= Y_THRESH + 5 and trace_y >= Y_THRESH - 5 and not vehicle.passed:
							...
							if vehicle.mph < 30:
								vehicle.mph = 20 + random.randint(1,11)
							elif vehicle.mph > 60:
								vehicle.mph = 60 - random.randint(1,21)
							...
							if vehicle.mph > HIGHWAY_SPEED_LIMIT:
								...
								print ('Car number is being detected')
